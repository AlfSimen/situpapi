...
public class Controller {
    ...
    static {
        ...
        events.add(new Event(0, "Ongoing Event", "Ongoing event", "skal akkurat vises", now.minusHours(2), now, "Håvard Halse", "Innebandy", "Håvard Halse", "http://anewlifeinnorway.files.wordpress.com/2009/11/innebandy.gif", "1337", new DateTime(2014, 6, 10, 0, 0)));
